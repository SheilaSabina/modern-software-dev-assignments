...
Description: Returns a newline-delimited list of "function_name: return_type"
for each top-level function in a Python file.

When asked to call a tool:
...
Always call the tool using the exact name:
